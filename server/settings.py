...
try:
    ...
    print("No custom configuration found, using default configuration!")
...
# 在操作日志中详细记录的请求模块映射
API_MODEL_MAP = {
    "/api/system/refresh": "Token Refresh",
    "/api/system/upload": "File Upload",
    "/api/system/login": "User Login",
    "/api/system/logout": "User Logout",
    "/api/flower": "Timed Task",
}
