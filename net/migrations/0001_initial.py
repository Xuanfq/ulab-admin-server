    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('src_ip', models.GenericIPAddressField(null=True, verbose_name='Source IP')),
                ('src_port', models.IntegerField(null=True, verbose_name='Srouce Port')),
                ('protocol', models.CharField(choices=[('HTTP', 'HTTP'), ('HTTPS', 'HTTPS'), ('RDP', 'RDP'), ('SSH', 'SSH'), ('TELNET', 'TELNET'), ('TCP', 'TCP'), ('UDP', 'UDP')], max_length=20, verbose_name='Protocol')),
                ('dst_ip', models.GenericIPAddressField(verbose_name='Destination IP')),
                ('dst_port', models.IntegerField(verbose_name='Destination Port')),
                ('is_active', models.BooleanField(default=False, verbose_name='Enable')),
            ...
            options={
                'verbose_name': 'Net Forward',
                'verbose_name_plural': 'Net Forward',
            },
        ),
    ]
